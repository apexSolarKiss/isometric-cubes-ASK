# ////////////////////////////////////////////////////////////////
# full random // randomly spawns grid-aligned isometric cubes in a muted purple ASK color palette
# ////////////////////////////////////////////////////////////////
...
# ////////////////////////////////////////////////////////////////
# refactored/adapted from p5.js >> https://editor.p5js.org/asymptoticSystemKey/sketches/bWa1wvK3r
# ////////////////////////////////////////////////////////////////
...
def settings():
    ...
    # anything that needs py5’s runtime (eg. py5.color) goes in "setup"
...
def draw():
    ...
    # 2/ random grid‑aligned position
    # x >> aligned on a skewed isometric grid // x is compressed by cos(30°) in iso‑projection
    x_cells = 32 / math.cos(math.radians(31))
    x       = math.floor(py5.random(0, x_cells)) * grid_unit * math.cos(math.radians(30))

    # y >> aligned on a straight grid // 19 rows
    y       = math.floor(py5.random(0, 19)) * grid_unit

    # 3/ random radius (size)
